...
func init() {
	...
	httpHandlerFuncList = append(httpHandlerFuncList,
		...
		&handlerFuncObj{Url: "/ci-template", Method: "POST", HandlerFunc: ci.CreateCiTemplate, LogOperation: true, ApiCode: "CreateCiTemplate"},
		&handlerFuncObj{Url: "/ci-template", Method: "PUT", HandlerFunc: ci.UpdateCiTemplate, LogOperation: true, ApiCode: "UpdateCiTemplate"},
		&handlerFuncObj{Url: "/ci-template", Method: "DELETE", HandlerFunc: ci.DeleteCiTemplate, LogOperation: true, ApiCode: "DeleteCiTemplate"},
		&handlerFuncObj{Url: "/ci-template-attr/list", Method: "POST", HandlerFunc: ci.ListCiAttrTemplate, ApiCode: "ListCiAttrTemplate"},
		&handlerFuncObj{Url: "/ci-template-attr", Method: "POST", HandlerFunc: ci.CreateCiAttrTemplate, LogOperation: true, ApiCode: "CreateCiAttrTemplate"},
		&handlerFuncObj{Url: "/ci-template-attr", Method: "PUT", HandlerFunc: ci.UpdateCiAttrTemplate, LogOperation: true, ApiCode: "UpdateCiAttrTemplate"},
		&handlerFuncObj{Url: "/ci-template-attr", Method: "DELETE", HandlerFunc: ci.DeleteCiAttrTemplate, LogOperation: true, ApiCode: "DeleteCiAttrTemplate"},
		&handlerFuncObj{Url: "/state-config/state-machine/list", Method: "POST", HandlerFunc: ci.ListStateMachine, ApiCode: "ListStateMachine"},
		&handlerFuncObj{Url: "/state-config/state-machine", Method: "POST", HandlerFunc: ci.CreateStateMachine, LogOperation: true, ApiCode: "CreateStateMachine"},
		&handlerFuncObj{Url: "/state-config/state-machine", Method: "PUT", HandlerFunc: ci.UpdateStateMachine, LogOperation: true, ApiCode: "UpdateStateMachine"},
		&handlerFuncObj{Url: "/state-config/state-machine", Method: "DELETE", HandlerFunc: ci.DeleteStateMachine, LogOperation: true, ApiCode: "DeleteStateMachine"},
		&handlerFuncObj{Url: "/state-config/state-machine/query", Method: "GET", HandlerFunc: ci.GetStateMachineDetail, ApiCode: "GetStateMachineDetail"},
		&handlerFuncObj{Url: "/state-config/state-machine/import", Method: "POST", HandlerFunc: ci.ImportStateMachine, ApiCode: "ImportStateMachine"},
		&handlerFuncObj{Url: "/state-config/state-machine/confirm", Method: "POST", HandlerFunc: ci.ConfirmStateImport, LogOperation: true, ApiCode: "ConfirmStateImport"},
		&handlerFuncObj{Url: "/state-config/state/list", Method: "POST", HandlerFunc: ci.ListState, ApiCode: "ListState"},
		&handlerFuncObj{Url: "/state-config/state", Method: "POST", HandlerFunc: ci.CreateState, LogOperation: true, ApiCode: "CreateState"},
		&handlerFuncObj{Url: "/state-config/state", Method: "PUT", HandlerFunc: ci.UpdateState, LogOperation: true, ApiCode: "UpdateState"},
		&handlerFuncObj{Url: "/state-config/state", Method: "DELETE", HandlerFunc: ci.DeleteState, LogOperation: true, ApiCode: "DeleteState"},
		&handlerFuncObj{Url: "/state-config/transition/list", Method: "POST", HandlerFunc: ci.ListStateTransition, ApiCode: "ListStateTransition"},
		&handlerFuncObj{Url: "/state-config/transition", Method: "POST", HandlerFunc: ci.CreateStateTransition, LogOperation: true, ApiCode: "CreateStateTransition"},
		&handlerFuncObj{Url: "/state-config/transition", Method: "PUT", HandlerFunc: ci.UpdateStateTransition, LogOperation: true, ApiCode: "UpdateStateTransition"},
		&handlerFuncObj{Url: "/state-config/transition", Method: "DELETE", HandlerFunc: ci.DeleteStateTransition, LogOperation: true, ApiCode: "DeleteStateTransition"},
	)
	// ciAttributes
	httpHandlerFuncList = append(httpHandlerFuncList,
	...
	httpHandlerFuncList = append(httpHandlerFuncList,
		...
		&handlerFuncObj{Url: "/view-message/:id", Method: "GET", HandlerFunc: view.GetViewMessage, ApiCode: "GetViewMessage"},
		&handlerFuncObj{Url: "/views", Method: "POST", HandlerFunc: view.ViewCreate, LogOperation: true, ApiCode: "ViewCreate"},
		&handlerFuncObj{Url: "/views", Method: "PUT", HandlerFunc: view.ViewUpdate, LogOperation: true, ApiCode: "ViewUpdate"},
		&handlerFuncObj{Url: "/views", Method: "DELETE", HandlerFunc: view.ViewDelete, LogOperation: true, ApiCode: "ViewDelete"},
		&handlerFuncObj{Url: "/view-graphs-query", Method: "POST", HandlerFunc: view.GraphList, ApiCode: "GraphList"},
		&handlerFuncObj{Url: "/view-graphs", Method: "POST", HandlerFunc: view.GraphCreate, LogOperation: true, ApiCode: "GraphCreate"},
		&handlerFuncObj{Url: "/view-graphs", Method: "PUT", HandlerFunc: view.GraphUpdate, LogOperation: true, ApiCode: "GraphUpdate"},
		&handlerFuncObj{Url: "/view-graphs", Method: "DELETE", HandlerFunc: view.GraphDelete, LogOperation: true, ApiCode: "GraphDelete"},
		&handlerFuncObj{Url: "/view-elements-query", Method: "POST", HandlerFunc: view.ElementList, ApiCode: "ElementList"},
		&handlerFuncObj{Url: "/view-elements", Method: "POST", HandlerFunc: view.ElementCreate, LogOperation: true, ApiCode: "ElementCreate"},
		&handlerFuncObj{Url: "/view-elements", Method: "PUT", HandlerFunc: view.ElementUpdate, LogOperation: true, ApiCode: "ElementUpdate"},
		&handlerFuncObj{Url: "/view-elements", Method: "DELETE", HandlerFunc: view.ElementDelete, LogOperation: true, ApiCode: "ElementDelete"},
		&handlerFuncObj{Url: "/view-elements/attr/list", Method: "GET", HandlerFunc: view.GetElementRefAttr, ApiCode: "GetElementRefAttr"},
